...
export const useNumbersError = 'Invalid useNumbers. It must be a boolean value.'
...
export const useSymbolsError = 'Invalid useSymbols. It must be a boolean value.'
...
export const passphraseErrors = {
  invalidWordCount: 'Invalid wordCount. It must be a positive number between 1 and 100.',
